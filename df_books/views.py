...
def index(request):
    ...
    nnn=5
    type0=typelist[0].booksinfo_set.order_by('-id')[0:nnn]
    type01=typelist[0].booksinfo_set.order_by('-gclick')[0:nnn]
    type1=typelist[1].booksinfo_set.order_by('-id')[0:nnn]
    type11=typelist[1].booksinfo_set.order_by('-gclick')[0:nnn]
    type2=typelist[2].booksinfo_set.order_by('-id')[0:nnn]
    type21=typelist[2].booksinfo_set.order_by('-gclick')[0:nnn]
    ...
    time = timezone.localtime(timezone.now()).month
